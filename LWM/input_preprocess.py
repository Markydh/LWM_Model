...
# #%% Scenarios List
# def scenarios_list():
#     """Returns an array of available scenarios_test."""
#     return np.array([
...
#     parameters['dataset_folder'] = '/Users/dianhongyang/Desktop/毕业设计/LWM_MODEL/LWM/scenarios'
...
# #%% Label Generation
# def label_gen(task, data, scenario, n_beams=16):
...
#             else:
#                 # chs[b, j] 表示 在波束方向 b 上，用户天线 j 接收到的信号强度。
...
# def label_prepend(deepmimo_data, preprocessed_chs, task, scenario_idxs, n_beams=16):
#     labels = []
...
# def create_labels(task, scenario_names, n_beams=16):
#     labels = []
